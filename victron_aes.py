...
#
# this is a complete strip-down from the original PYAES library found here:
# https://github.com/ricmoo/pyaes/tree/master
#
# this version now runs on a Raspberry Pi Pico W under micropython
# and is used the decrypt data blocks from Victron-Solar Charger device
#
# put this file into the LIB directory on the PICO to access it from regular micropython scripts
#
# use it, modify, whatever - thank you PYAES
